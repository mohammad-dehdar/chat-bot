...
export function Sidebar({ className }: SidebarProps = {}) {
  ...
  const floatingSearchRef = useRef<InputRef | null>(null);
      ...
      <div className={`flex items-center p-2 ${isOpen ? 'justify-end' : 'justify-center'}`}>
        <motion.div whileTap={{ scale: 0.95 }}>
          <Button
            ...
            className="rounded-lg border border-divider bg-white/30 p-2 text-foreground transition-colors hover:bg-surface"
